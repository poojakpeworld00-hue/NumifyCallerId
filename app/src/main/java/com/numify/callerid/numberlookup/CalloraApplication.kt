package com.numify.callerid.numberlookup
...
import com.numify.callerid.adkit.runtime.OpenAdManager.isAdAvailable
...
import com.numify.callerid.numberlookup.screen.launch.LaunchActivity
    ...
    override fun onCreate() {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            try {
                ...
                AccessEngine.init(this@NumifyApplication)
            } catch (e: Exception) {
                EdgeInsets.log("NumifyApplication", "LightHouse init failed: ${e.message}")
            }
        }
