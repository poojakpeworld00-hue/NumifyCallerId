...
object CountryCatalog {
    ...
    fun byIso(iso2: String): CountryEntry? =
        all.firstOrNull { it.iso2.equals(iso2, ignoreCase = true) }

    val all: List<CountryEntry> = listOf(
        CountryEntry("United States", "US", "1"),
        CountryEntry("United Kingdom", "GB", "44"),
        CountryEntry("India", "IN", "91"),
        CountryEntry("Canada", "CA", "1"),
        CountryEntry("Australia", "AU", "61"),
        CountryEntry("Germany", "DE", "49"),
        CountryEntry("France", "FR", "33"),
        CountryEntry("Spain", "ES", "34"),
        CountryEntry("Italy", "IT", "39"),
        CountryEntry("Brazil", "BR", "55"),
        CountryEntry("Mexico", "MX", "52"),
        CountryEntry("Japan", "JP", "81"),
        CountryEntry("China", "CN", "86"),
        CountryEntry("Russia", "RU", "7"),
        CountryEntry("South Africa", "ZA", "27"),
        CountryEntry("Nigeria", "NG", "234"),
        CountryEntry("Indonesia", "ID", "62"),
        CountryEntry("Philippines", "PH", "63"),
        CountryEntry("Türkiye", "TR", "90"),
        CountryEntry("Egypt", "EG", "20"),
        CountryEntry("Pakistan", "PK", "92"),
        CountryEntry("Bangladesh", "BD", "880"),
        CountryEntry("United Arab Emirates", "AE", "971"),
        CountryEntry("Saudi Arabia", "SA", "966"),
        CountryEntry("Thailand", "TH", "66"),
        CountryEntry("Vietnam", "VN", "84"),
        CountryEntry("Malaysia", "MY", "60"),
        CountryEntry("Singapore", "SG", "65"),
        CountryEntry("Netherlands", "NL", "31"),
        CountryEntry("Belgium", "BE", "32"),
        CountryEntry("Switzerland", "CH", "41"),
        CountryEntry("Austria", "AT", "43"),
        CountryEntry("Sweden", "SE", "46"),
        CountryEntry("Norway", "NO", "47"),
        CountryEntry("Denmark", "DK", "45"),
        CountryEntry("Finland", "FI", "358"),
        CountryEntry("Poland", "PL", "48"),
        CountryEntry("Portugal", "PT", "351"),
        CountryEntry("Greece", "GR", "30"),
        CountryEntry("Ireland", "IE", "353"),
        CountryEntry("Czech Republic", "CZ", "420"),
        CountryEntry("Romania", "RO", "40"),
        CountryEntry("Ukraine", "UA", "380"),
        CountryEntry("Hungary", "HU", "36"),
        CountryEntry("Israel", "IL", "972"),
        CountryEntry("South Korea", "KR", "82"),
        CountryEntry("Hong Kong", "HK", "852"),
        CountryEntry("Taiwan", "TW", "886"),
        CountryEntry("New Zealand", "NZ", "64"),
        CountryEntry("Argentina", "AR", "54"),
        CountryEntry("Chile", "CL", "56"),
        CountryEntry("Colombia", "CO", "57"),
        CountryEntry("Peru", "PE", "51"),
        CountryEntry("Kenya", "KE", "254"),
        CountryEntry("Ghana", "GH", "233"),
        CountryEntry("Morocco", "MA", "212"),
        CountryEntry("Qatar", "QA", "974"),
        CountryEntry("Kuwait", "KW", "965"),
        CountryEntry("Sri Lanka", "LK", "94"),
        CountryEntry("Nepal", "NP", "977")
    )
