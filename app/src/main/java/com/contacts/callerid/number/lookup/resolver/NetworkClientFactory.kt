...
import com.contacts.callerid.number.lookup.ContactsApplication
...
object NetworkClientFactory {
     ...
     */
    val BASE_URL: String get() = EndpointConfig.baseUrl(ContactsApplication.appContext)

    private val okHttpClient: OkHttpClient by lazy {
        val builder = OkHttpClient.Builder()
            .addInterceptor(ApiKeyInterceptor(ContactsApplication.appContext))
            ...
            .addInterceptor(
                ChuckerInterceptor.Builder(ContactsApplication.appContext)
