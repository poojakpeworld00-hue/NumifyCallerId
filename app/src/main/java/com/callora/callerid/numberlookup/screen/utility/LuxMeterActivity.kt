...
import com.callora.callerid.numberlookup.databinding.ScreenLightMeterBinding
import kotlin.math.roundToInt

/** Ambient light meter (lux) using the device light sensor. */
class LuxMeterActivity : CoreActivity<ScreenLightMeterBinding>(), SensorEventListener {
