...
/** Whole-log counts, independent of the row window [CallLogSource.getCalls] returns. */
        ...
        context.contentResolver.query(
            ...
            while (cursor.moveToNext() && result.size < limit) {
                val type = when (cursor.getInt(typeIdx)) {
                    ...
                    CallLog.Calls.REJECTED_TYPE -> CallDirection.MISSED
                    CallLog.Calls.BLOCKED_TYPE -> CallDirection.SPAM
