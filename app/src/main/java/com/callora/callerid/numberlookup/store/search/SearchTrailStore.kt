package com.callora.callerid.numberlookup.store.search

import android.content.Context
import com.callora.callerid.numberlookup.screen.search.TrailEntry
 ...
 */
class SearchTrailStore(context: Context) {

    private val prefs = context.applicationContext
        .getSharedPreferences(PREFS, Context.MODE_PRIVATE)

    fun all(): List<TrailEntry> {
