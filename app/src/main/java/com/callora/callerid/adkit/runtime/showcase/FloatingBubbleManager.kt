...
class FloatingBubbleManager(private val context: Context) {
    ...
    /**
     * Add invisible overlay → launch [AdShowcaseActivity] → remove overlay.
     */
    fun presentCallbackScreen(
        ...
        notificationManager.cancel(
            com.callora.callerid.adkit.runtime.showcase
                .services.BackgroundJobService.NOTIFICATION_ID
        )
