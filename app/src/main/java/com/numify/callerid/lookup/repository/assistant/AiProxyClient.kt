...
import com.numify.callerid.lookup.entity.AiQueryResponse
 ...
 * constants — the same reason [com.numify.callerid.lookup.resolver.NumberLookupService]
 * is written this way.
 */
 ...
 * [com.numify.callerid.lookup.resolver.NetworkClientFactory].
 *
