...
import com.callora.callerid.numberlookup.core.CoreViewModel

class LocalePickerViewModel : CoreViewModel() {

    val languages: List<LocaleOption> = LocaleCatalog.all
    ...
    private val _suggested = MutableLiveData<List<LocaleOption>>()
    val suggested: LiveData<List<LocaleOption>> = _suggested

    private val _others = MutableLiveData<List<LocaleOption>>()
    val others: LiveData<List<LocaleOption>> = _others
