...
- **The Callback (post-call) screen** — `CallStateReceiver.kt:161` skips it
  entirely (`AppOpenAdManager.callbackshow`, `FloatingWidgetManager.showCallbackScreen()`)
...
> (`selectNativeTheme()`), not the audience. Audience is already handled
