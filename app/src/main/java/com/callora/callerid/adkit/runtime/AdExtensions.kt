...
import com.callora.callerid.numberlookup.databinding.SheetAppRedirectBinding
import kotlin.apply
import kotlin.let
...
fun Activity.showAppRedirectPopup(onDismiss: (() -> Unit)? = null) {
    val appUrl = AdsPrefStore(this).getString("In_App_Update_Link")
...
fun Context.getLast_Result_HD_VBC_Type() = AdsPrefStore.getInstance(this).result_HD_VBC_Type

fun Context.getHD_VBC_Type(): String {
    val type = AdsPrefStore.getInstance(this).getString("HD_VBC_Type") ?: "nb"
...
inline fun <reified T : Activity> Context.openActivity(
    ...
    StandardInterstitial().presentInterstitial(activity) {
