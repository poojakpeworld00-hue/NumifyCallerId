...
object LocaleCatalog {
    val all: List<LocaleOption> = listOf(
        LocaleOption("en", "EN", "English", "English", "US"),
        LocaleOption("hi", "HI", "Hindi", "हिन्दी", "IN"),
        LocaleOption("es", "ES", "Spanish", "Español", "ES"),
        LocaleOption("fr", "FR", "French", "Français", "FR"),
        LocaleOption("pt", "PT", "Portuguese", "Português", "PT"),
        LocaleOption("th", "TH", "Thai", "ไทย", "TH"),
        LocaleOption("zh", "ZH", "Chinese", "中文", "CN"),
        LocaleOption("ja", "JA", "Japanese", "日本語", "JP"),
        LocaleOption("ru", "RU", "Russian", "Русский", "RU"),
        LocaleOption("vi", "VI", "Vietnamese", "Tiếng Việt", "VN"),
        LocaleOption("tr", "TR", "Turkish", "Türkçe", "TR")
    )

    private fun byTag(tag: String): LocaleOption? = all.firstOrNull { it.tag == tag }
     ...
     */
    fun suggestedFor(iso2: String?): List<LocaleOption> {
