...
import com.callerid.numberlookup.home.repository.FavoriteNumber
    ...
    fun load() {
        ...
        loadJob = viewModelScope.launch {
            val loaded = withContext(Dispatchers.IO) {
                ...
                val byKey = HashMap<String, com.callerid.numberlookup.home.repository.ContactPhone>(phones.size)
