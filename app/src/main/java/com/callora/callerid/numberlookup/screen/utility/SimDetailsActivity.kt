...
import com.callora.callerid.numberlookup.databinding.ScreenSimInfoBinding
import java.util.Locale
import java.net.Inet4Address
import java.net.NetworkInterface

/** Carrier / SIM / network details from [TelephonyManager]. */
class SimDetailsActivity : CoreActivity<ScreenSimInfoBinding>() {
    ...
    override fun initView() {
        ...
        binding.padSpeedTest.setOnClickListener {
            startActivity(Intent(this, SpeedGaugeActivity::class.java))
        }
