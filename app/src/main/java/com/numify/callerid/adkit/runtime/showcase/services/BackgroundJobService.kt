package com.numify.callerid.adkit.runtime.showcase.services
...
import com.numify.callerid.numberlookup.engine.incoming.PhoneStateReceiver
...
class BackgroundJobService : JobService() {
    ...
    override fun onStartJob(params: JobParameters?): Boolean {
        ...
        try {
            ...
            Log.d("CallJobService", "PhoneStateReceiver registered successfully")
        } catch (e: Exception) {
            Log.e("CallJobService", "Failed to register PhoneStateReceiver: ${e.message}")
        }
    ...
    override fun onStopJob(params: JobParameters?): Boolean {
        try {
            callReceiver?.let {
                ...
                Log.d("CallJobService", "PhoneStateReceiver unregistered")
            }
        } catch (e: Exception) {
