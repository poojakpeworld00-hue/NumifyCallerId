...
import com.callora.callerid.numberlookup.databinding.PaneContactsBinding
...
class PhonebookFragment : CoreFragment<PaneContactsBinding>() {
    ...
    private fun onPermissionGranted() {
        ...
        com.callora.callerid.numberlookup.engine.ContactSyncer
    ...
    private fun openDetail(contact: com.callora.callerid.numberlookup.store.PhonebookEntry) {
