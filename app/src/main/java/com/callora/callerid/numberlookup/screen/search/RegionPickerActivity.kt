...
import com.callora.callerid.numberlookup.databinding.ScreenCountryPickerBinding

/** Searchable country list. Returns the chosen country's ISO/dial/name. */
class RegionPickerActivity : CoreActivity<ScreenCountryPickerBinding>() {
    ...
    override fun initView() {
        ...
        adapter = CountryListAdapter { country ->
            setResult(
                Activity.RESULT_OK,
                Intent()
