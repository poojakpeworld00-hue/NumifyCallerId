package com.callora.callerid.numberlookup.screen.consent
 ...
 * `HomeShellActivity.startOverlayPermissionFlow()` owns the only implementation
...
object BubbleUtils {
     ...
     *
     * Lingering is handled instead by `HomeShellActivity.exitToHome()`, which
