...
for line in [
    ...
    "Package: com.callora.callerid  ->  com.numify.callerid          applicationId: com.numify.callerid",
...
table_page("1. Identity and branding", "Stage 2.",
           ...
           [["Root package", "com.callora.callerid", "com.numify.callerid"],
            ["namespace", "com.callora.callerid.numberlookup", "com.numify.callerid.lookup"],
            ["applicationId", "com.callora.callerid.numberlookup", "com.numify.callerid"],
...
table_page("15. Deliberate exclusions and follow-ups", "Read this before shipping.",
           ...
           [["34 ad-layout view IDs kept",
            ...
            ["google-services.json is a placeholder",
             "Replace with the real Firebase config for com.numify.callerid before any build you ship."],
