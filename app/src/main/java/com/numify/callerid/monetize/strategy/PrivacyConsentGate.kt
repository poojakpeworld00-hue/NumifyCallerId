...
class PrivacyConsentGate private constructor(context: Context) {
    ...
    companion object {
        private var instance: PrivacyConsentGate? = null
        fun getInstance(context: Context): PrivacyConsentGate {
            if (instance == null) {
                instance = PrivacyConsentGate(context)
            }
